...
--
-- Client: localhost
-- Généré le: Jeu 22 Janvier 2015 à 17:13
...
--
CREATE DATABASE IF NOT EXISTS `long2net` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `long2net`;
...
--
-- Création: Lun 19 Janvier 2015 à 12:53
--
...
(8, 'book_008', 'PHP/MySQL avec Dreamweaver MX', '', 'programmation web', 'Français', 'Jean-Marie Defrance', 'Eyrolles', '2004', '', '15.0', '20.0', '3.0', '0.00', 'réservé'),
(9, 'book_009', 'PHP 4 et MySQL en ligne', 'L''essentiel pour concevoir un site web dynamique', 'programmation web', 'Français', 'Cyril Nocton', 'Micro Application', '2001', '', '19.0', '12.5', '2.0', '9.45', 'réservé'),
...
(14, 'book_014', 'WAP', 'ePocket Book', 'programmation web', 'Français', 'Christian Germain, Jean Marc Herellier, Philippe Mérigot', 'Campus Press', '2000', '', '18.5', '11.5', '1.5', '8.99', 'réservé'),
...
(16, 'book_016', 'Unix', 'Le grand livre', 'systèmes et réseaux', 'Français', 'Michael Wielsch', 'Micro Application', '1995', 'CD', '24.5', '17.5', '5.5', '44.97', 'réservé'),
...
(18, 'book_018', 'XML étape par étape', 'Manuel de formation', 'programmation web', 'Français', 'Michael J. Young', 'Microsoft Press', '2001', 'CD', '23.5', '19.0', '3.0', '22.71', 'réservé'),
...
(21, 'book_021', 'WAP', 'Construire une application', 'programmation web', 'Français', 'Letourmy, Papiernik, Hélaïli, Martzel', 'Eyrolles', '2000', '', '23.0', '19.0', '2.0', '36.06', 'réservé'),
...
(25, 'book_025', 'SQL Server 7.0', 'Kit de formation', 'systèmes et réseaux', 'Français', NULL, 'Microsoft Press', '1999', 'CD', '23.5', '18.5', '5.0', '45.58', 'réservé'),
...
(35, 'book_035', 'Vie', 'catalogue stock images', 'graphisme', 'Français', NULL, 'Getty Images', NULL, 'CD', '30.0', '23.0', '2.0', '0.00', 'réservé'),
(36, 'book_036', 'Section', 'catalogue stock images', 'graphisme', 'Français', NULL, 'PhotoDisc', NULL, 'CD', '28.0', '21.5', '1.5', '0.00', 'réservé'),
(37, 'book_037', 'Photodisc', 'catalogue stock images', 'graphisme', 'Français', NULL, 'PhotoDisc', NULL, 'CD', '28.0', '21.5', '2.0', '0.00', 'disponible');

-- --------------------------------------------------------

--
-- Structure de la table `resas`
--
-- Création: Jeu 22 Janvier 2015 à 13:09
--

DROP TABLE IF EXISTS `resas`;
CREATE TABLE IF NOT EXISTS `resas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ref` varchar(8) NOT NULL,
  `nom` varchar(64) DEFAULT NULL,
  `email` varchar(64) NOT NULL,
  `resa` varchar(512) DEFAULT NULL,
...
--
-- Vider la table avant d'insérer `resas`
--

TRUNCATE TABLE `resas`;
